...
Public Class FilmSelection
    ...
    Private Sub FilmSelection_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            query = "SELECT film.film_id FROM film, dtheatre WHERE film.film_id = dtheatre.film_id GROUP BY film_id LIMIT 10;"
            ...
            If dt.Rows.Count = 10 Then
                ...
                Label1.Text = simpan.Rows(0).Cells(0).Value.ToString()
                Label2.Text = simpan.Rows(1).Cells(0).Value.ToString()
                Label3.Text = simpan.Rows(2).Cells(0).Value.ToString()
                Label4.Text = simpan.Rows(3).Cells(0).Value.ToString()
                Label5.Text = simpan.Rows(4).Cells(0).Value.ToString()
                Label6.Text = simpan.Rows(5).Cells(0).Value.ToString()
                Label7.Text = simpan.Rows(6).Cells(0).Value.ToString()
                Label8.Text = simpan.Rows(7).Cells(0).Value.ToString()
                Label9.Text = simpan.Rows(8).Cells(0).Value.ToString()
                Label10.Text = simpan.Rows(9).Cells(0).Value.ToString()
